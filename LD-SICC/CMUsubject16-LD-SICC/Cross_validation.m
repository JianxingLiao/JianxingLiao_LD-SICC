...
TRAIN_X1=CMUsubject16_TRAIN_X;%Y文件是X文件的标签
TRAIN_Y1=CMUsubject16_TRAIN_Y;
TEST_X1=CMUsubject16_TEST_X;
TEST_Y1=CMUsubject16_TEST_Y;
means=CMUsubject16_means; %均值矩阵，数据集类别*维度
