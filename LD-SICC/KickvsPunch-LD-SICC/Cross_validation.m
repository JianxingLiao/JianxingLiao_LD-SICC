...
load KickvsPunch_inverse;
load KickvsPunch_means;

TRAIN_X1=KickvsPunch_TRAIN_X;%Y文件是X文件的标签
TRAIN_Y1=KickvsPunch_TRAIN_Y;
TEST_X1=KickvsPunch_TEST_X;
TEST_Y1=KickvsPunch_TEST_Y;
means=KickvsPunch_means; %均值矩阵，数据集类别*维度
...
Ma=KickvsPunch_inverse;
Me=KickvsPunch_inverse;
