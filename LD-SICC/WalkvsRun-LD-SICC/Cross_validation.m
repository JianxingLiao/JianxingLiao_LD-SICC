...
load WalkvsRun_inverse;
load WalkvsRun_means;

TRAIN_X1=WalkvsRun_TRAIN_X;%Y文件是X文件的标签
TRAIN_Y1=WalkvsRun_TRAIN_Y;
TEST_X1=WalkvsRun_TEST_X;
TEST_Y1=WalkvsRun_TEST_Y;
means=WalkvsRun_means; %均值矩阵，数据集类别*维度
...
Ma=WalkvsRun_inverse;
Me=WalkvsRun_inverse;
