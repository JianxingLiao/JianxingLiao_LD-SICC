function [Dist]=dl_metric(MTS_1,MTS_2,M)
MTS_1=MTS_1';%变成d*m
MTS_2=MTS_2';


[~,col_1]=size(MTS_1); %列是样本的数目，col_1是列，就是时间点的数目
[row,col_2]=size(MTS_2); 

d=zeros(col_1,col_2);%建立一个m*n的距离矩阵
% D1=MTS_1'*M*MTS_1;
% D2=MTS_2'*M*MTS_2;
% D3=MTS_1'*M*MTS_2;
% 
% for i=1:col_1 %为什么可以这么计算距离矩阵
%     for j=1:col_2
