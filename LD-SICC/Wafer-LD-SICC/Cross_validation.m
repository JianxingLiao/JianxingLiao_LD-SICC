...
TRAIN_X1=Wafer_TRAIN_X;%Y文件是X文件的标签
TRAIN_Y1=Wafer_TRAIN_Y;
TEST_X1=Wafer_TEST_X;
TEST_Y1=Wafer_TEST_Y;
means=Wafer_means; %均值矩阵，数据集类别*维度
...
for k_i=1:k_fold
    ...
    for kk=1:40%总的循环次数
        ...
        fprintf('------------------------\n');
        if(train_accuracy==1.000000&&test_accuracy==1.000000)
            break;
        end
    end
