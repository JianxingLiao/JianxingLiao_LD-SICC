...
load NetFlow_TEST_X
load NetFlow_TEST_Y
load NetFlow_inverse;
load NetFlow_means;

TRAIN_X1=NetFlow_TRAIN_X;%Y文件是X文件的标签
TRAIN_Y1=NetFlow_TRAIN_Y;
TEST_X1=NetFlow_TEST_X;
TEST_Y1=NetFlow_TEST_Y;
means=NetFlow_means; %均值矩阵，数据集类别*维度
