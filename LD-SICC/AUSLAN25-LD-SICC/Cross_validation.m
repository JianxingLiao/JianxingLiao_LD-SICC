...
load AUSLAN25_inverse;
load AUSLAN25_means;

TRAIN_X1=AUSLAN25_TRAIN_X;%Y文件是X文件的标签
TRAIN_Y1=AUSLAN25_TRAIN_Y;
TEST_X1=AUSLAN25_TEST_X;
TEST_Y1=AUSLAN25_TEST_Y;
means=AUSLAN25_means; %均值矩阵，数据集类别*维度
